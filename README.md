...
## Current CFD simulation library

The portfolio currently contains five simulations in `videos/CFD_Water/`:

1. **PCM and Air Interface**
2. **PCM Enthalpy-Porosity + Air VOF**
3. **Fin with Air Flow**
4. **PCM Encapsulation: Solidification and Liquification**
5. **PCM Melting at Different Levels**

The gallery reads the generated manifest automatically, so these titles and descriptions appear on the site without HTML or JavaScript edits.
